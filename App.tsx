...
const API_URL = 'https://relevant-humpback-83.hasura.app/v1/graphql';
const HEADERS = {
    ...
    try {
      const res = await fetch(API_URL, {
        ...
        body: JSON.stringify({
          ...
          `,
          variables: { title: currentTask, userId: USER_ID }
        })
      });
      const json = await res.json();
...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, backgroundColor: '#FFFFFF', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12, fontSize: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2, elevation: 2 },
